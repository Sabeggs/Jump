...
public class LoadSave {
    ...
    // public static final String FROG_DEAD = "/res/Frog_Dead.png"; // Currently uses IDLE for DEAD

    // Level and UI elements
    ...
    public static final String REGISTER_SUBMIT_BUTTON_PRESSED = "/res/submit_pressed.png";
    ...
    public static BufferedImage[][] loadAnimations(PlayerCharacter pc) {
        ...
        switch (pc) {
            case FROG:
                ...
                animations[DEAD] = cutSheet(GetSpriteAtlas(FROG_IDLE), pc.getSpriteAmount(DEAD), frogSpriteW, frogSpriteH); // Using IDLE for DEAD
                break;
            default:
    ...
    public static BufferedImage[] GetHeartAnimationSprites() {
        BufferedImage heartSheet = GetSpriteAtlas(HEART_SPRITE_SHEET);
